...
export default function App() {
  ...
  const categoryImages: Record<string, string> = {
    "Teknologi": "https://images.unsplash.com/photo-1568952433726-3896e3881c65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwaW5ub3ZhdGlvbnxlbnwxfHx8fDE3NjIzNjI4MjJ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Pendidikan": "https://images.unsplash.com/photo-1654626565332-a69a5fc80e21?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlZHVjYXRpb24lMjBzdHVkZW50c3xlbnwxfHx8fDE3NjI2ODc0MzF8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Lingkungan": "https://images.unsplash.com/photo-1726597904186-c6ad20c21b03?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxlbnZpcm9ubWVudCUyMG5hdHVyZXxlbnwxfHx8fDE3NjI2ODk2MzZ8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Olahraga": "https://images.unsplash.com/photo-1762341582157-20d9e1430f9a?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzcG9ydHMlMjBjb21wZXRpdGlvbnxlbnwxfHx8fDE3NjI3MDQzNTl8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Seni & Budaya": "https://images.unsplash.com/photo-1761124739933-009df5603fbf?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxjdWx0dXJlJTIwZmVzdGl2YWx8ZW58MXx8fHwxNzYyNzYyMTM0fDA&ixlib=rb-4.1.0&q=80&w=1080",
    "Gaya Hidup": "https://images.unsplash.com/photo-1610060616036-09bd2c69e8d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsaWZlc3R5bGUlMjB3ZWxsbmVzc3xlbnwxfHx8fDE3NjI2ODc1NzV8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Sosial": "https://images.unsplash.com/photo-1610060616036-09bd2c69e8d6?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxsaWZlc3R5bGUlMjB3ZWxsbmVzc3xlbnwxfHx8fDE3NjI2ODc1NzV8MA&ixlib=rb-4.1.0&q=80&w=1080",
    "Ekonomi": "https://images.unsplash.com/photo-1568952433726-3896e3881c65?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHx0ZWNobm9sb2d5JTIwaW5ub3ZhdGlvbnxlbnwxfHx8fDE3NjIzNjI4MjJ8MA&ixlib=rb-4.1.0&q=80&w=1080",
  };
...
Program ini mendapat respons positif dari pelajar dan orang tua. Diharapkan akan ada lebih banyak kafe yang bergabung dalam inisiatif ini.`
  ...
  const handleSubmitArticle = (earnedGlowbits: number, thumbnailUrl?: string) => {
    ...
    <div className="min-h-screen bg-background">
        ...
        <Login 
          onLogin={async (email, password) => {
            try {
              ...
              if (data.user) {
                setUserEmail(email);
                setUserName(data.user.user_metadata.name || "Kamu");
      ...
      {isAuthenticated && (
        <div className="min-h-screen bg-background">
          ...
          <FloatingWriteButton onClick={() => setCurrentSection("write")} />
          ...
          <main className="container mx-auto px-4 py-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                          {articles.map((article) => (
                            <NewsCard
                              ...
                              imageUrl={categoryImages[article.category]}
                            />
                          ))}
                        </div>
                      </TabsContent>
            ...
            {currentSection === "article" && selectedArticle && (
              <ArticleDetail
