import { X, User, Info, BarChart3, LogOut, HelpCircle } from "lucide-react";
...
export function Sidebar({ isOpen, onClose, onNavigate, currentSection, userName }: SidebarProps) {
  const menuItems = [
